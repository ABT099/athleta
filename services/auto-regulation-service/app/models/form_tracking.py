"""
Form quality tracking model (auto-regulation-owned, algo state).

Tracks form quality trends per exercise per athlete for data-driven form
degradation detection and progressive-overload gating. athlete_id / exercise_id
are soft integer references to api / exercise-service.
"""
...
class FormQualityTrend(AutoregBase):
    """
    ...
    athlete_id = Column(Integer, nullable=False)  # soft ref → api athletes.id
