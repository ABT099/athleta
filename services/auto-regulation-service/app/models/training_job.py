"""
ML Training Job tracking model (auto-regulation-owned, algo state).
"""
from sqlalchemy import Column, Integer, String, Enum, DateTime, Text, Index, JSON
from datetime import datetime, timezone
import enum

from app.database import AutoregBase, get_table_args_with_constraints
...
class MLTrainingJob(AutoregBase):
    """
