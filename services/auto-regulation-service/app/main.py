...
from autoregulation.api import workouts, periodization, ml, prescriptions, injury_prevention
...
app.include_router(injury_prevention.router, prefix="/api", tags=["injury-prevention"])
