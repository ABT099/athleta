...
from autoregulation.models import WorkoutSession, ExerciseSet, Exercise, Athlete
...
from autoregulation.utils.constants import TrainingExperience, PROGRESSION_RATES
    ...
    def check_form_degradation(self, athlete_id: int, sessions_to_check: int = 3) -> Dict:
        ...
        for session in recent_sessions:
            ...
            for exercise_id, metrics in session_metrics.items():
                ...
                from autoregulation.utils.constants import FORM_DEGRADATION_THRESHOLD
