...
from autoregulation.models import ExerciseSet, WorkoutSession, Exercise
...
class PlateauInterventionService:
    ...
    def _get_intervention(
        ...
        if plateau_type == PlateauType.NEUROMUSCULAR:
            ...
            from autoregulation.services.exercise_substitutor import ExerciseSubstitutor
            substitutor = ExerciseSubstitutor(self.db)
