...
from autoregulation.models import RecoveryMetrics, WorkoutSession, Athlete, ExerciseSet, Exercise, MuscleGroupModel
...
class RecoveryAnalyzer:
    ...
    def assess_muscle_recovery(
        ...
        from autoregulation.models import ExerciseMuscle
        recent_sessions = (
