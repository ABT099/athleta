...
from autoregulation.services.exercise_progression import ExerciseProgressionService
from autoregulation.services.pr_tracker import PRTrackerService
from autoregulation.services.periodization import PeriodizationService
from autoregulation.services.rpe_calibration import RPECalibrationService
...
class ProgressiveOverloadEngine:
    ...
    def process_workout_completion(
        ...
        from autoregulation.services.plateau_intervention import PlateauInterventionService
        ...
        from autoregulation.ml.constrained_optimizer import ConstrainedOptimizer
    ...
    def calculate_next_workout_parameters(
        ...
        if performance_level == "exceeding":
            ...
            from autoregulation.utils.constants import PERFORMANCE_POOR_VOLUME_MULT, PERFORMANCE_POOR_INTENSITY_MULT
            ...
            from autoregulation.utils.constants import PERFORMANCE_STRUGGLING_VOLUME_MULT, PERFORMANCE_STRUGGLING_INTENSITY_MULT
    ...
    def _calculate_average_intensity(
        ...
        for ex_analysis in exercise_analyses:
            ...
            if estimated_1rm and estimated_1rm > 0:
                ...
                # Lookup intensity
                from autoregulation.utils.constants import RPE_TO_INTENSITY
