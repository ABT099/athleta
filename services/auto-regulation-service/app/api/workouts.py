...
from autoregulation.utils.helpers import get_athlete_or_404
...
from autoregulation.services.plan_updater import PlanUpdaterService
...
from autoregulation.services.workout_scheduler import WorkoutScheduler
...
def complete_workout(
    ...
    try:
        ...
        if ML_AVAILABLE:
            try:
                from autoregulation.models import MLTrainingJob, MLJobStatus, PlanEntry
        ...
        if _retraining_job_id:
            try:
                from autoregulation.tasks.ml_training import retrain_athlete_model
