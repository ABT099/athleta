...
@celery_app.task(bind=True, base=DatabaseTask, name="app.modules.ml.tasks.retrain_athlete_model")
...
@celery_app.task(name="app.modules.ml.tasks.check_and_queue_retraining")
