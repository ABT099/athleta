...
@celery_app.task(bind=True, base=DatabaseTask, name="app.tasks.ml_training.retrain_athlete_model")
...
@celery_app.task(name="app.tasks.ml_training.check_and_queue_retraining")
